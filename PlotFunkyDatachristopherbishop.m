...
p2 = bar([women_pc women_apple; men_pc men_apple], sterr); 
set(a2, 'YLim', [0 1.2])
...
a2 = subplot(1,3,1);title ('q2 plot');
p2 = plot([data{:,games_header}], [data{:, grade_header}], 'ko');
...
a3 = subplot(1,3,1);title ('q2 plot');
p3 = plot([data{:,sleep_header}], [data{:, games_header}], 'ko');
xlabel('Number of hours of sleep')
ylabel('grade')
% ================================% 
...
p3 = plot3([data{:,games_header}], [data{:, facebook_header}], [data{:, sleep_header}]);
xlabel('Number of hours gaming')
ylabel('Facebook friends')
zlabel('sleep')
...
caffeine_header=find(strcmp(headers,'caffeine'));

a4 = subplot(1,3,1)
plot([data{:,caffeine_header}], [data{:, sleep_header}], 'ko');
xlabel('Hours of Sleep')
ylabel('Amount of Caffeine')
